...
namespace SecureClient
{
    class Program
    {
        ...
        {
            Console.WriteLine("Making call fingers crossed.....");
            RunAsync().GetAwaiter().GetResult();
        }

        private static async Task RunAsync()
        {
            AuthConfig config = AuthConfig.ReadJsonFromFile("C:\\Repos\\SecureClient\\SecureClient\\appsettings.json");
            ...
            //Array used if you have more than ResourceId
